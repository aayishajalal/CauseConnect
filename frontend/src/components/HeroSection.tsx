  ...
  return (
    <section
      ...
      style={{
        ...
        backgroundImage:
          'url("https://img.freepik.com/premium-photo/world-charity-day-backgrounds_1198941-10278.jpg?w=740")',
    ...
    >
      ...
      <div className="relative z-10 max-w-3xl px-4 py-8 ">
        <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-6 text-blue-900">

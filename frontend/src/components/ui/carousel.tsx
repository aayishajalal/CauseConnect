...
//       spaceBetween: 30, // Space between each slide, you can adjust this value
...
//       },
//       speed: 1000, // Set the speed of transition
...
//   return (
//     <div className="swiper-container my-10 w-[80%] sm:w-[60%] lg:w-[40%]">
...
//                 className="w-full h-[200px] object-cover transition-all duration-500 transform hover:scale-105"
//               />
//             </div>
//           </div>
//         ))}
...
//       centeredSlides: true, // Ensure the active slide is always in the center
//       autoplay: {
//         delay: 3000, // Change to 3000ms (3 seconds) for smooth transition
//         disableOnInteraction: false, // Allow autoplay after user interaction
//       },
//       speed: 1500, // Set the speed of the transition (1.5 seconds)
//       effect: "slide", // Use the slide effect
//       on: {
//         init: () => {
//           console.log("Swiper initialized");
...
//                 src={src}
//                 alt={`Carousel Image ${index + 1}`}
//                 className="w-full h-[300px] object-cover transition-all duration-500 transform hover:scale-105"
//               />
//             </div>
//           </div>
//         ))}
